...
// Import all SVGs from the outlined directory as raw strings
...
const MaterialIconsControl = (props: MaterialIconWidgetProps) => {
    ...
    const handleSelectIcon = (iconKey: string) => {
        ...
        const svgWithId = svgElement.outerHTML;
    ...
    const formatIconName = (iconKey: string) => {
        return iconKey.replace(/_/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase());
    };
            ...
            <div className={classNameWrapper} ref={containerRef}>
                <div style={{ position: 'relative' }}>
                  ...
                  {formatIconName(currentIconId)}
                            ...
                            <span style={{ color: '#999', fontSize: '14px' }}>Оберіть іконку...</span>
                        )}
                    </div>
                                ...
                                >
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                                        ...
                                        <div>
                                            ...
                                            <div style={{ fontSize: '12px', color: '#666' }}>{currentIconId}</div>
                                        </div>
                                    </div>
                                    <button
                                        onClick={() => {
                                ...
                                {filteredIcons.map(([iconKey, svg]) => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            cursor: 'pointer',
                                            borderRadius: '4px',
                                            backgroundColor: currentIconId === iconKey ? '#e3f2fd' : 'transparent',
                                            border: currentIconId === iconKey ? '2px solid #2196f3' : '2px solid transparent',
                                            transition: 'all 0.2s ease',
                                        }}
                                        onClick={() => handleSelectIcon(iconKey)}
                                    >
                                        <div
                                            style={{ width: 40, height: 40, marginBottom: '4px' }}
